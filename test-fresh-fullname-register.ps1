# Test register with fresh fullName (frontend format)
$timestamp = Get-Date -Format "yyyyMMddHHmmss"
$registerData = @{
    fullName = "Fresh Test User $timestamp"
    email = "freshtest$timestamp@test.com"
    password = "password123"
    phoneNumber = "1234567890"
    dateOfBirth = "1990-01-01"
} | ConvertTo-Json

Write-Host "Testing register with fresh fullName (timestamp: $timestamp)..." -ForegroundColor Yellow
